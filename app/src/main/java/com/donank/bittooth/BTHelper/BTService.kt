...
class BTService constructor(context: Context, handler: Handler) {
    ...
    // messageConstants!! that indicate the current connection state
    ...
    fun connected(socket: BluetoothSocket, device: BluetoothDevice, socketType: String) {
        ...
        val msg = mHandler.obtainMessage(messageConstants!!.MESSAGE_DEVICE_NAME)
        val bundle = Bundle()
        bundle.putString(messageConstants!!!!.DEVICE_NAME, device.name)
        msg.setData(bundle)
    ...
    private fun connectionFailed() {
        ...
        val msg = mHandler.obtainMessage(messageConstants!!.MESSAGE_TOAST)
        val bundle = Bundle()
